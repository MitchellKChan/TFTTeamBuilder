    ...
    return (
        <div className="home">
            <div className="welcome px-3">
                ...
                <p className="lead">
                    <a href="https://github.com/MitchellKChan/TFTTeamBuilder" target="_blank" rel="noopener noreferrer" className="btn btn-lg btn-secondary fw-bold">GitHub repository</a>
                </p>
            </div>
